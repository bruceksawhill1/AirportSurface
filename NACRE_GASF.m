function nga = NACRE_GA( initial_aircraft_sequence, ...
    deterministic_permutations, ground_database, runway_name, safety_factor )
...
sust = zeros(length(soss_database(aci).nomSchTimes), 2);
